...
<div class="card mt-3 mb-0"> 
   <div class="card-header ">
      <div class="row">
                 <div class="col-sm-3 my-2"> <h5 class="mt-0">Ads  </h5></div>
 ...
 <table id="employee_data"  class="table table-bordered table-hover table-sm shadow">
    <thead>
       <tr>
          ...
          <th width="25%" class="sorting" data-sorting_type="asc" data-column_name="ads_name" style="cursor: pointer"> Ads Name 
                <span id="ads_name_icon" ><i class="fas fa-sort-amount-up-alt"></i></span> </th>

          <th width="25%" class="sorting" data-sorting_type="asc" data-column_name="link" style="cursor: pointer"> Link 
              <span id="link_icon" ><i class="fas fa-sort-amount-up-alt"></i></span> </th>       
         ...
         <th width="25%" class="sorting" data-sorting_type="asc" data-column_name="menu_ber" style="cursor: pointer"> Ads Size 
      ...
      <form  method="POST" id="add_employee_form" enctype="multipart/form-data">
        ...
        <div class="modal-body p-4 bg-light">
           <div class="row">
              ...
              <div class="col-lg-12">
                 <label for="roll"> Ads Name <span style="color:red;"> * </span></label>
                 <input type="text" name="ads_name" id="ads_name" class="form-control" placeholder="" required>
                 <p class="text-danger error_ads_name"></p>
              </div>

              <div class="col-lg-12">
                 <label for="roll"> Link <span style="color:red;"> * </span></label>
                 <input type="text" name="link" id="link" class="form-control" placeholder="" required>
                 <p class="text-danger error_link"></p>
              </div>
      ...
      <form  method="POST" id="edit_employee_form" enctype="multipart/form-data">
         ...
         <div class="modal-body p-4 bg-light">
          ...
          <div class="col-lg-12 my-2">
             ...
             <div class="col-lg-12 my-2">
                <label for="roll">Ads Name<span style="color:red;"> * </span></label>
                <input type="text" name="ads_name" id="edit_ads_name" class="form-control" placeholder="" required>
                <p class="text-danger error_ads_name"></p>
            </div>

            <div class="col-lg-12">
                 <label for="roll">Link<span style="color:red;"> * </span></label>
                 <input type="text" name="link" id="edit_link" class="form-control" placeholder="" required>
                 <p class="text-danger error_edit_link"></p>
              </div>


            <div class="col-lg-12">
                    <label class=""> Ads Size  <span style="color:red;"> * </span></label>
            ...
            <div class="col-lg-6 my-2">
                  <label class=""><b>Ads Status</b></label>
                    <select class="form-select" name="ads_status" id="edit_ads_status" aria-label="Default select example">
...
<script>  
  $(document).ready(function(){ 
       ...
       $("#add_employee_form").submit(function(e) {
        ...
        $.ajax({
          ...
          success: function(response){
              ...
              $("#edit_ads_name").val(response.data.ads_name);
              $("#edit_ads_status").val(response.data.ads_status);
   ...
   function fetch_data(page, sort_type="", sort_by="", search="",range=""){
    $.ajax({
      url:"/admin/ads/fetch_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&search="+search+"&range="+range,
     beforeSend : function()
               {
               $('.loader_page').show();
               },
