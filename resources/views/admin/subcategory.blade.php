...
<div class="card mt-3 mb-0"> 
   <div class="card-header ">
      <div class="row">
                 <div class="col-sm-3 my-2"> <h5 class="mt-0">Sub Category  </h5></div>
 ...
 <table id="employee_data"  class="table table-bordered table-hover table-sm shadow">
    <thead>
       <tr>
         ...
         <th width="25%" class="sorting" data-sorting_type="asc" data-column_name="subcategory_name" style="cursor: pointer">Sub Category Name 
                <span id="subcategory_name_icon" ><i class="fas fa-sort-amount-up-alt"></i></span> </th>


          <th width="25%" class="sorting" data-sorting_type="asc" data-column_name="sub_name" style="cursor: pointer">Sub  Name 
              <span id="sub_name_icon" ><i class="fas fa-sort-amount-up-alt"></i></span> </th>        
    ...
    <div class="modal-content">
      ...
      <form  method="POST" id="add_employee_form" enctype="multipart/form-data">
        ...
        <div class="modal-body p-4 bg-light">
           <div class="row">
               <div class="col-lg-12">
                   <label for="roll"> Sub Category Name <span style="color:red;"> * </span></label>
                   <input type="text" name="subcategory_name" id="subcategory_name" class="form-control" placeholder="" required>
                   <p class="text-danger error_subcategory_name"></p>
               </div>

               <div class="col-lg-12">
                   <label for="roll"> Sub Name <span style="color:red;"> * </span></label>
                   <input type="text" name="sub_name" id="sub_name" class="form-control" placeholder="" required>
                   <p class="text-danger error_sub_name"></p>
               </div>

                <div class="col-lg-12">
                      <label class=""> Category Name <span style="color:red;"> * </span></label>
      ...
      <form  method="POST" id="edit_employee_form" enctype="multipart/form-data">
         ...
         <div class="modal-body p-4 bg-light">
          ...
          <div class="col-lg-12 my-2">
             ...
             <div class="col-lg-12 my-2">
                <label for="roll">Sub Category Name<span style="color:red;"> * </span></label>
                <input type="text" name="subcategory_name" id="edit_subcategory_name" class="form-control" placeholder="" required>
                <p class="text-danger error_subcategory_name"></p>
            </div>

            <div class="col-lg-12">
                   <label for="roll"> Sub Name <span style="color:red;"> * </span></label>
                   <input type="text" name="sub_name" id="edit_sub_name" class="form-control" placeholder="" required>
            ...
            <div class="col-lg-12">
                  <label class=""> Category Name <span style="color:red;"> * </span></label>
                      <select class="form-select" name="category_name_id" id="edit_category_name_id" aria-label="Default select example" required>
                        <option   value=""> Select One </option>
                           @foreach($category as $row)
                              <option   value="{{$row->category_name}}">{{$row->name}}</option>
                           @endforeach  
            ...
            <div class="col-lg-6 my-2">
                  <label class=""><b>subcategory Status</b></label>
                    <select class="form-select" name="subcategory_status" id="edit_subcategory_status" aria-label="Default select example">
...
<script>  
  $(document).ready(function(){ 
       ...
       $("#add_employee_form").submit(function(e) {
        ...
        $.ajax({
          ...
          success: function(response){
              ...
              $("#edit_subcategory_status").val(response.data.subcategory_status);
              $("#edit_category_name_id").val(response.data.category_name_id);
   ...
   function fetch_data(page, sort_type="", sort_by="", search="",range=""){
    $.ajax({
      url:"/admin/subcategory/fetch_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&search="+search+"&range="+range,
     beforeSend : function()
               {
               $('.loader_page').show();
               },
